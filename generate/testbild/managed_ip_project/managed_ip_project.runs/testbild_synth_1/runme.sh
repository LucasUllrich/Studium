...
HD_PWD='/home/lullrich/Dokumente/Studium/4_Semester/Chip_Design/Project/VGA_Controller/generate/testbild/managed_ip_project/managed_ip_project.runs/testbild_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log testbild.vds -m64 -mode batch -messageDb vivado.pb -notrace -source testbild.tcl
